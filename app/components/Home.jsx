...
class Home extends Component {
    ...
    render() {
      ...
      <div className="container">
        ...
        <div className="row">
            <div className="col-md-4"><h3>Enlarge Item on Hover</h3></div>
            <div className="col-md-4"><h3>Delayed Fade-In on load</h3></div>
            <div className="col-md-4"><h3>Search icon that expands to input box</h3></div>
        </div>
        <div className="row">
